...
public class SchemaRegistryTransfer<R extends ConnectRecord<R>> implements Transformation<R> {
    ...
    public CachedSchemaRegistryClient getSourceSchemaRegistryClient()
    {
        return sourceSchemaRegistryClient;
    }

    public void setSourceSchemaRegistryClient(CachedSchemaRegistryClient sourceSchemaRegistryClient)
    {
        this.sourceSchemaRegistryClient = sourceSchemaRegistryClient;
    }

    public CachedSchemaRegistryClient getDestSchemaRegistryClient()
    {
        return destSchemaRegistryClient;
    }

    public void setDestSchemaRegistryClient(CachedSchemaRegistryClient destSchemaRegistryClient)
    {
        this.destSchemaRegistryClient = destSchemaRegistryClient;
    }
